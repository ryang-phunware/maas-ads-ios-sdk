...
@property(nonatomic, retain) PWAdsVideoManager *adsManager;
...
@property(nonatomic, retain) PWAdsVideoAdError *adError;
/// Other user context object returned by the adsLoader.
@property(nonatomic, retain) id userContext;

@end

@class PWAdsVideoAdsLoader;
...
/// object.
@property(nonatomic, assign) NSObject<PWAdsVideoAdsLoaderDelegate> *delegate;
