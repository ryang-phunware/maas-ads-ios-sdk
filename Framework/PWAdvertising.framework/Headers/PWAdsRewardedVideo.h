...
/**
 ...
 @param rewardedVideo The video ad that will dismiss modal.
 @param adExtensionData Ad Extension Data contains information about the rewarded video. i.e. remaining views count for the current user.
 */
...
/**
 ...
 @param rewardedVideo The video ad that did dismiss modal.
 @param adExtensionData Ad Extension Data contains information about the rewarded video. i.e. remaining views count for the current user.
 */
...
/**
 Called right before the rewarded video ad leaves the application.
 
 @param rewardedVideo The video ad that will leave application
 */
- (void)rewardedVideoWillLeaveApplication:(PWAdsRewardedVideo *)rewardedVideo;
