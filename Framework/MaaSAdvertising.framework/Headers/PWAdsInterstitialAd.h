...
/**
 Once `- (BOOL)loadInterstitialForRequest:(PWAdsRequest *)request;` has been called and your have received notification that the ad has loaded, this function should be called to present the ad within your app.
 @param request The ad request with zone information and any custom parameters.
 */
...
/**
 An `id` that is used to identify the 'PWAdsInterstitialAdDelegate' delegate.
 */
